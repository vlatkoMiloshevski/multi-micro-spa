...
module.exports = function (db, pgp) {
    ...
    const create_singlespa_user = pgp.as.format(`CREATE TABLE IF NOT EXISTS $1(id SERIAL, name varchar(255), email varchar(255), hashedPassword varchar(255))`, singlespa_user);
